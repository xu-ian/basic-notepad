...
void drawAxisY(int offSet, int color)
{
    ...
    for (int i = 0; i < Width; i++)
    {
        putpixel(i, Height - g_offSet - 20, color);
    }
}
...
void drawAxisX(int offSet, int color)
{
    ...
    for (int i = 0; i < Height; i++)
    {
        putpixel(i, Width - g_offSet - 20, color);
    }
}
...
void drawRect(Point a, Point b, int col)
{
    convertPixel(a.x,a.y);
    convertPixel(b.x,b.y);
